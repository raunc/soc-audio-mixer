...
proc create_root_design { parentCell } {
  ...
  # Create instance: zedboard_audio_0, and set properties
  set zedboard_audio_0 [ create_bd_cell -type ip -vlnv user.org:user:zedboard_audio:1.0 zedboard_audio_0 ]
  ...
  connect_bd_net -net zedboard_audio_0_AC_GPIO0 [get_bd_ports AC_GPIO0] [get_bd_pins zedboard_audio_0/AC_GPIO0]
  connect_bd_net -net zedboard_audio_0_AC_MCLK [get_bd_ports AC_MCLK] [get_bd_pins zedboard_audio_0/AC_MCLK]
  connect_bd_net -net zedboard_audio_0_AC_SCK [get_bd_ports AC_SCK] [get_bd_pins zedboard_audio_0/AC_SCK]
  connect_bd_net -net zedboard_audio_0_line_in_l [get_bd_pins Audio_to_AXI_0/LINE_IN_L] [get_bd_pins zedboard_audio_0/line_in_l]
  connect_bd_net -net zedboard_audio_0_line_in_r [get_bd_pins Audio_to_AXI_0/LINE_IN_R] [get_bd_pins zedboard_audio_0/line_in_r]
  connect_bd_net -net zedboard_audio_0_new_sample [get_bd_pins Audio_to_AXI_0/NEW_SAMPLE_IN] [get_bd_pins zedboard_audio_0/new_sample]
